      ...
      <div className="flex items-center gap-0"> {/* Gap removido para aproximar o texto do logo */}
        <div className="relative group">
          ...
          <img 
            ...
            alt="Logo UMADEMATS" 
            className="w-16 h-16 sm:w-20 sm:h-20 object-contain relative z-10 contrast-[1.05] brightness-[1.10] transition-transform duration-500 group-hover:scale-105" 
            style={{ 
              imageRendering: 'auto',
        ...
        <div className="flex flex-col -ml-3"> {/* Aproximação adicional via margem negativa */}
