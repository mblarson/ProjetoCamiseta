...
export const Button: React.FC<{
  ...
  const base = "font-manrope font-extrabold uppercase text-[11px] sm:text-xs md:text-sm tracking-widest px-4 sm:px-8 py-3.5 sm:py-4 rounded-xl sm:rounded-2xl transition-all duration-300 active:scale-95 flex items-center justify-center gap-2 sm:gap-3 disabled:opacity-50 disabled:cursor-not-allowed";
  const variants = {
